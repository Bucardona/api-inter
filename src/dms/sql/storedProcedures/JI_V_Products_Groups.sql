ALTER VIEW JI_V_Products_Groups AS

/*
* Version: 1.0.0
* Fecha: 30-abr-2024
* Descripcion: Vista para clasificar los items en grupos, subgrupos, subgrupos3, subgrupos4, subgrupos5, piedra y material
*/
...
CROSS APPLY (
    VALUES 
		...
		(idTalla, NULL,'6','Talla', Talla),
		(idColor, NULL,'7','Color', Color)
